...
class HelperSettingsFragment :
    ...
    override fun onCreatePreferences(p0: Bundle?, p1: String?) {
        addPreferencesFromResource(R.xml.settings_helper)
    }
    ...
    override fun onResume() {
        ...
        updateTitle(R.string.setting_main_helper_title)
    }
    ...
    override fun onPreferenceTreeClick(preference: Preference): Boolean {
        ...
        when (preference.key) {
            ...
            resources.getString(R.string.pref_key_asr_helper_kakao_screen) -> {
                val browserIntent = Intent(
                    Intent.ACTION_VIEW,
                    Uri.parse("http://pf.kakao.com/_BUJUb")
                )
    ...
    companion object {
        ...
        fun newInstance(): HelperSettingsFragment {
            return HelperSettingsFragment()
        }
    }
}
