 ...
 * Home
 */
private fun home(state: AppState): AppState {
    return state.copy(screen = Screen.Home)
}
...
private fun navigateUp(state: AppState, action: AppAction.NavigateUp): AppState {
    ...
    val screen = when (state.screen.page) {
        Screen.Settings.Page.Start -> if (action.tabId != null) {
            ...
            Screen.Settings(page = Screen.Settings.Page.Main)
        }
        ...
        Screen.Settings.Page.Helper -> Screen.Settings(page = Screen.Settings.Page.Main)

        Screen.Settings.Page.General -> Screen.Settings(page = Screen.Settings.Page.Main)
        Screen.Settings.Page.Privacy -> Screen.Settings(page = Screen.Settings.Page.Start)
        Screen.Settings.Page.Search -> Screen.Settings(page = Screen.Settings.Page.Main)
        ...
        Screen.Settings.Page.SearchAutocompleteAdd -> Screen.Settings(page = Screen.Settings.Page.SearchAutocompleteList)
        Screen.Settings.Page.SearchAutocompleteRemove -> Screen.Settings(page = Screen.Settings.Page.SearchAutocompleteList)
