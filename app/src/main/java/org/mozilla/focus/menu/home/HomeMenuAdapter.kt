...
class HomeMenuAdapter(
    ...
    private val items: List<MenuItem> = listOf(
        ...
        MenuItem(R.id.privacy_policy, MenuItemViewHolder.LAYOUT_ID, context.getString(R.string.menu_privacy_policy)),
        MenuItem(R.id.sign_out, MenuItemViewHolder.LAYOUT_ID, context.getString(R.string.menu_signout)),
