...
class BrowserMenuController(
    ...
    private val openBookmarks: () -> Unit,
    private val goHome: () -> Unit,
    private val setCaption: () -> Unit,
    private val addBookmark: () -> Unit,
) {
    @VisibleForTesting
    ...
    fun handleMenuInteraction(item: ToolbarMenu.Item) {
        when (item) {
            ...
            is ToolbarMenu.Item.Bookmarks -> openBookmarks()
            ...
            is ToolbarMenu.Item.Home -> goHome()
            is ToolbarMenu.Item.Caption -> setCaption()
            is ToolbarMenu.Item.AddBookmark -> addBookmark()
        }
    }
}
