...
class BrowserToolbarIntegration(
    ...
    private val onCheckStartURL: () -> Unit,
    ...
    init {
        ...
        toolbar.edit.apply {
            colors = colors.copy(
                ...
                text = ContextCompat.getColor(toolbar.context, R.color.white)
            )
        }
    ...
    private fun setUrlBackground() {
        ...
        // FIXME jhong - Caused by java.lang.UnsupportedOperationException 에러 수정
