...
class SearchSettingsFragment :
    ...
    override fun onCreatePreferences(p0: Bundle?, p1: String?) {
        ...
        // 추천 검색어 켜기 제거
        if (preferenceManager.findPreference<Preference>(getString(R.string.pref_key_show_search_suggestions)) != null) {
            preferenceScreen.removePreference(findPreference(getString(R.string.pref_key_show_search_suggestions)))
        }
    }
