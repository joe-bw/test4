...
class Settings private constructor(
    ...
    fun shouldDisplayHomescreenTips() =
        preferences.getBoolean(
            ...
            false  // update: sorizava no tips needed
        )
    ...
    fun userHasToggledSearchSuggestions(): Boolean =
        preferences.getBoolean(SearchSuggestionsPreferences.TOGGLED_SUGGESTIONS_PREF, true)  // modify: sorizava false -> true
    ...
    fun isDarkMode(): String =
        preferences.getString(
            getPreferenceKey(
                R.string
                    .pref_key_asr_general_theme_screen
            ),
            resources.getString(R.string.preference_theme_light_mode)
        )!!
