...
class AddToHomescreenDialogFragment : DialogFragment() {
    ...
    private fun setButtons(
        ...
        val addToHomescreenDialogCancelButton = parentView.findViewById<Button>(R.id.addtobookmark_dialog_cancel)
        val addToHomescreenDialogConfirmButton = parentView.findViewById<Button>(R.id.addtobookmark_dialog_add)
    ...
    companion object {
        val FRAGMENT_TAG = "add-to-bookmark-prompt-dialog"
        private val URL = "url"
